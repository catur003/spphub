        ...
        <table className="w-full min-w-[720px] border-separate border-spacing-0">
          <thead>
            <tr>
              ...
              <SortHeader label="Kelas" field="kelas" width="15%" sortField={sortField} sortAsc={sortAsc} onClick={toggleSort} />
              <SortHeader label="Periode Tagihan" field="periode" width="18%" sortField={sortField} sortAsc={sortAsc} onClick={toggleSort} />
              <SortHeader label="Nominal SPP" field="nominal" width="15%" sortField={sortField} sortAsc={sortAsc} onClick={toggleSort} />
              <SortHeader label="Status" field="status" width="12%" sortField={sortField} sortAsc={sortAsc} onClick={toggleSort} />
          ...
          <tbody>
            {loadingData ? (
              <tr>
                <td colSpan={6} className="border-b border-slate-100 bg-white py-10 text-center">
