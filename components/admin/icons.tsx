// Ikon inline (project ini gak punya lucide-react/icon library, jadi bikin set kecil sendiri
// biar gak nambah dependency baru yang belum tentu ke-install mulus di build Railway).
...
export function IconUsers(props: IconProps) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M15 14.2c2.6.5 5 2.7 5 5.8" />
    </svg>
  );
}
...
export function IconMegaphone(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M11 6l-3-3H2v10h6l3 3V6z" />
...
export function IconFolderArchive(props: IconProps) {
  return (
    <svg {...base} {...props}>
